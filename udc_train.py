...
#FLAGS is a way to give command line parameters to the program
...
def main(unused_argv):
  ...
  input_fn_train = udc_inputs.create_input_fn(#for training data
    mode=tf.contrib.learn.ModeKeys.TRAIN,
    input_files=[TRAIN_FILE],
    batch_size=hparams.batch_size,
    num_epochs=FLAGS.num_epochs)

  input_fn_eval = udc_inputs.create_input_fn(#for evaluation data
  ...
  #evaluates our model every FLAGS.eval_every steps during training
...
#Tensorflow automatically saves checkpoint files in MODEL_DIR
