...
def create_input_fn(mode, input_files, batch_size, num_epochs):
    #create input_fn in different modes
  def input_fn():
      #Load and preprocess data here
    features = tf.contrib.layers.create_feature_spec_for_parsing(
        get_feature_columns(mode))#Create a feature definition that describes the fields in our Example file
    ...
    return feature_map, target #return the batched examples and training labels
  return input_fn
